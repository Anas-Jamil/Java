...
public class Binary
{
	...
	*/
	...
	{
		// the index of the last digit of each number
	...
	public static Binary ORR(Binary num1, Binary num2)
	{
		int ind1 = num1.number.length() - 1;
		int ind2 = num2.number.length() - 1;
	...
	public static Binary Multiply(Binary num1, Binary num2) {
		...
		for (int i = len1 - 1; i >= 0; i--) {
			for (int j = len2 - 1; j >= 0; j--) {
				int bit1 = num1.number.charAt(i) - '0';
				int bit2 = num2.number.charAt(j) - '0';
		...
		String finalResult = binaryResult.length() == 0 ? "0" : binaryResult.toString();
